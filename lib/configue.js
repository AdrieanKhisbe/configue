...
internals.configueTemplate = (configue, defaults = {}) => (chains, ...keys) => {
...
internals.Configue.prototype.template = function(defaultOrChain, ...keys){
    if(_.isPlainObject(defaultOrChain))
       return internals.configueTemplate(this, defaultOrChain)
    else
        return internals.configueTemplate(this)(defaultOrChain, ...keys)

};

internals.Configue.prototype.t = internals.Configue.prototype.template;
