...
Configue.files = (opt) => { Configue._options.files = opt; return Configue; };
Configue.defaults = (opt) => { Configue._options.defaults = opt; return Configue; };
Configue.env = (opt) => { Configue._options.env = opt; return Configue; };
Configue.argv = (opt) => { Configue._options.argv = opt; return Configue; };
Configue.customWorkflow = (opt) => { Configue._options.customWorkflow = opt; return Configue; };
...
const _resolve = (self, callback) => {
    ...
    const markAsDone = (callback) => (err, res) => {
        self.resolved = true;
        callback(err, res)
    }
